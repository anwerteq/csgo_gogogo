...
public class GoodInfo {
    ...
    private int appid;
    private boolean can_3d_inspect;
    ...
    public void setCan_3d_inspect(boolean can_3d_inspect) {
         this.can_3d_inspect = can_3d_inspect;
     }
     public boolean getCan_3d_inspect() {
         return can_3d_inspect;
     }

    public void setCan_inspect(boolean can_inspect) {
         this.can_inspect = can_inspect;
     }
     public boolean getCan_inspect() {
         return can_inspect;
     }
