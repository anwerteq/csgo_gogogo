package com.xiaojuzi.util.bufflogin;

import com.alibaba.fastjson.JSONObject;
import com.xiaojuzi.Application;
...
import com.xiaojuzi.test.SliderCaptchaSolver;
...
//            browser.close();
    ...
    public static String getResource() {
        // 获取资源的URL
        URL resourceUrl = Application.class.getClassLoader().getResource("edgedriver_win64/msedgedriver.exe");
        // 获取资源的绝对路径
