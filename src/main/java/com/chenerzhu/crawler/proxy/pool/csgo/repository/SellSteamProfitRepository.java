...
public interface SellSteamProfitRepository extends JpaRepository<SellSteamProfitEntity, Long> {
    ...
    @Query(value = "select * from sell_steam_profit where sell_num > 20 and buff_price < '50'  and buff_price > '0.1'  and interest_rate < '0.75' ORDER BY interest_rate", nativeQuery = true)
