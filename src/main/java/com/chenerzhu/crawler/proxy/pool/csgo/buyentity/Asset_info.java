/**
  ...
  */
package com.chenerzhu.crawler.proxy.pool.csgo.buyentity;
...
public class Asset_info {
    ...
    private long tradable_unfrozen_time;
    ...
    public void setTradable_unfrozen_time(long tradable_unfrozen_time) {
         this.tradable_unfrozen_time = tradable_unfrozen_time;
     }
     public long getTradable_unfrozen_time() {
